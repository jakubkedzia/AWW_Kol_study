    ...
    public partial class m1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Lauges", x => x.LeaugeId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Teams_Lauges_LeaugeId",
                        column: x => x.LeaugeId,
                        principalTable: "Lauges",
                        principalColumn: "LeaugeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MatchPlayers_Positions_PostionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MatchPlayers_PostionId",
                table: "MatchPlayers",
                column: "PostionId");
